...
namespace Unit04.Game.Casting
{
    ...
    public class Point
    {
        ...
        /// <summary>
        /// See if a point collides with another point
        /// </summary>
        /// <param name="factor">point 2.</param>
        /// <returns>A scaled instance of Point.</returns>
        public bool Collide(Point point2)
        {   if(Math.Abs(this.x-point2.GetX())<15 & Math.Abs(this.y-point2.GetY())<15)
            {
                return true;
            }
            return false;
