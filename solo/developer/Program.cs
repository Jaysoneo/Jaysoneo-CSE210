...
//selector
            ...
            {
                ///<sumary>Displays the board</summary>
                ///<param name=Game>"A list of strings with the info of the game"</param>
                ///<returns>"Nothing, just shows the board in the terminal"</returns>
            ...
            {   ///<sumary>
                ...
                ///</summary>
                ///<param name=Game>"A list of strings with the info of the game"</param>
                ///<returns>"A bool variable, True if it wins, False if it doesn't win"</returns>
                bool finish = false;
                ...
                else if((Game[2] == Game[4]) & (Game[2] == Game[6]) & (Game[4] == Game[6]))
                {
                    finish = true;
                }
                return finish;
